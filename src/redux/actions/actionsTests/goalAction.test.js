...
import { goalActionsType } from '../../typesRedux/goal';

describe('goal actions', () => {
  it('setGoalItems(): should create an action to set goal items', () => {
  ...
  it('setGoalChangeTask(): should create an action to set change goal task', () => {
    const expectedAction = {
